...
**2** Sum Bearing and non-bearing. Easy. **3** Calculate the average proportion of grown that bearing or non bearing(as the case may be) is for the state in question. Then we use that to figure out the value.
